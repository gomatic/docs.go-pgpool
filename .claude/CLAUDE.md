# `docs.go-pgpool` — public documentation repository

This is the **public** documentation site for [`gomatic/go-pgpool`](https://github.com/gomatic/go-pgpool), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-pgpool`](https://github.com/gomatic/go-pgpool)'s API changes, update [`content/`](../content/) to match.
